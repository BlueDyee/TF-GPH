...
class ShareSelfAttentionControl(AttentionBase):
    ...
    def __init__(self, start_step=4, start_layer=10, layer_idx=None, step_idx=None, total_steps=20,scales=None, model_type="SD"):
        ...
        print("ShareSelfAttentionControl at denoising steps: ", self.step_idx)
        print("ShareSelfAttentionControl at U-Net layers: ", self.layer_idx)
        if self.scales!=None:
            print("Similarity Rescales=",self.scales)
