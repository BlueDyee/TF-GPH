...
class AttentionBase:
    ...
    def forward(self, q, k, v, sim, attn, is_cross, place_in_unet, num_heads, **kwargs):
        ...
        # print("Normal out1:",out.shape)
        # print("Normal atten:",attn.shape)
...
def regiter_attention_editor_diffusers(model, editor: AttentionBase):
    ...
    """
    def ca_forward(self, place_in_unet,**kwarg):
        def forward(x, encoder_hidden_states=None, attention_mask=None, context=None, mask=None,**kwarg):
            """
